...
section .rodata
    ...
    txt_sobel_filter_ptx db 'kernels/sobel_filter.ptx', 0
    txt_sobel_filter db 'sobel_filter', 0
    ...
    msg_ptx_opening db '[D] Opening PTX file: sobel_filter.ptx', 0xA, 0
...
load_ptx_module:
    ...
    mov rdx, txt_sobel_filter    ; function name
